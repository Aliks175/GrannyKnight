...
namespace Refactor
{
    public class TestPlayerMove : ITickable
    {
        ...
        //private float _questWalk = 2f;
        //private bool _isAim;

        //private PlayerControlAnimation _playerControlAnimation;
        //private bool _isQuest = false;

        public TestPlayerMove(SettingsPlayer settingsPlayer, CharacterController characterController, Transform groundPoint)
        {
            _normalSpeed = settingsPlayer.MovementSpeed;
            _normalCoefficientSpeedForAir = settingsPlayer.CoefficientSpeedWalkForAir;
            //_coefficientSpeedForAim = settingsPlayer.CoefficientSpeedForAim;
        ...
        public void ProcessMove(Vector2 pos)
        {
            ...
            _speed = _normalSpeed * _coefficientSpeedForAim * _coefficientSpeedForAir;
