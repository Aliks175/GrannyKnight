...
namespace Refactor
{
    public class ImporterAimSensitivity : IDisposable, IInitializable
    {
        ...
        private TestPlayerLook _testPlayerLook;
        private float _coefficientSensitivityAim;

        private readonly float _normalCoefficientSensitivityAim;

        public ImporterAimSensitivity(TestPlayerAim testPlayerAim, TestPlayerLook testPlayerLook, SettingsPlayer settingsPlayer)
        {
