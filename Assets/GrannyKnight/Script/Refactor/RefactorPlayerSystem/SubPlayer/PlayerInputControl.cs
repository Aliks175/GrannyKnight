...
namespace Refactor
{
    public class PlayerInputControl : IDisposable, IInitializable, ILateTickable, ITickable
    {
        ...
        public PlayerInputControl(TestPlayerCharacter testPlayerCharacter, PlayerSystemActions inputActions, TestPlayerInteracteble testPlayerInteracteble, TestWeaponSystem testWeaponSystem)
        {
